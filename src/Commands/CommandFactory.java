...
public class CommandFactory {
    ...
    public CommandFactory(Server myServer, Client client, ConcurrentHashMap<String, String> symbolTable,
        ...
        commandsSupplierMap.put(DISCONNECT_COMMAND, () -> new DisconnectCommand(this.client));
